    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MainActivityMoveData.EXTRA_NAME, "Audi Syahzehan");
                moveWithDataIntent.putExtra(MainActivityMoveData.EXTRA_AGE, 17);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_with_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Audi");
                mPerson.setAge(17);
                mPerson.setEmail("audisyzhn@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "+6285559422228";
